...
=&\bigg[X_i'\beta + \sigma_\varepsilon \lambda\bigg(\frac{X_i'\beta-c}{\sigma_\varepsilon}\bigg)\bigg]\cdot \Phi\bigg(\frac{X_i'\beta-c}{\sigma_\varepsilon}\bigg)+c\cdot \bigg[1-\Phi\bigg(\frac{X_i'\beta-c}{\sigma_\varepsilon}\bigg)\bigg]
\end{aligned}
$$
...
-   **conditional on observation/selection:** $\frac{\partial E[Y_i|D_i=1,X_i]}{\partial X_i} = \bigg[1 + \lambda'\bigg(\frac{X_i'\beta-c}{\sigma_\varepsilon}\bigg)\bigg]\beta$
