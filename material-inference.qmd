...
[^1]: In Handout 4 we showed that $\beta_1$ can be written as $c'\beta$ where $c = \begin{bmatrix}1 & 0 & \dots &0\end{bmatrix}'$. Therefore, it must be that $(X_1'M_2X_1)^{-1} = c'(X'X)^{-1}c$
